...
alias du-sort='du --human-readable --max-depth=1 | sort --human-numeric-sort'
alias e='${EDITOR}'
alias edit='${EDITOR}'
...
# alias l='exa'
# alias la='exa --sort created -la'
# alias list='exa'
# alias ll='exa --sort created -l'
# alias ls='exa'

#alias ls='exa --sort created'
#alias ls-gnu='/bin/ls'
...
alias grep='rg --no-ignore-parent'
